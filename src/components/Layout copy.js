...
export default function Layout({ window, children }) {
  ...
  const [Layout_Show, setLayout_Show] = useState("Realm_Yok")
  ...
  if (!RealmApp.currentUser) {
    return (
      <>
        {/* kullNICI yoK */}
        {loginFormMode === "sifreYenileme" && <FormSifreYenileme setLoginFormMode={setLoginFormMode} />}
        {loginFormMode === "login" && <FormSignIn setLoginFormMode={setLoginFormMode} />}
  ...
  if (!loginFormMode && !RealmApp.currentUser.customData?.mailTeyit) {
    return (
      <>
        {/* kullanıcı var, mail teyit yok */}
        {/* {console.log("userLayout",RealmApp?.currentUser)} */}
        {<FormMailTeyit setLoginFormMode={setLoginFormMode}/>}
      </>
    )
  }
