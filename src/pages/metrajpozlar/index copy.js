  ...
  return (
    ...
    <>
      ...
      {show == "Main" && wbsArray?.length > 0 &&
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: `auto 1fr 0.5rem auto 0.5rem auto 0.5rem auto`, maxWidth: "70rem", mt: subHeaderHeight, pt: "1rem", pl: "1rem", pr: "1rem" }}>
          ...
          <>
            ...
            <Box sx={{ mb: "0rem", fontWeight: "600", display: "grid", justifyContent: "center", px: "0.5rem", backgroundColor: "white", color: "white" }}>.</Box>
            <Box sx={{ mb: "0rem", fontWeight: "600", border: "1px solid black", display: "grid", px: "0.5rem", justifyContent: "center", backgroundColor: "lightGray", maxWidth: "7rem", textAlign: "center" }}>Hazırlanan Miktar</Box>
