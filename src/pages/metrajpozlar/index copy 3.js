  ...
  return (
    ...
    <>
      ...
      {show == "Main" && wbsArray?.length > 0 &&
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: `auto 1fr 0.5rem auto 0.5rem auto auto 0.5rem auto`, maxWidth: "70rem", gridTemplateAreas: gridAreas, mt: subHeaderHeight, pt: "1rem", pl: "1rem", pr: "1rem" }}>
          ...
          <>
            ...
            <Box sx={{ mb: "0rem", fontWeight: "600", border: "1px solid black", display: "grid", gridArea: "user1", px: "0.5rem", justifyContent: "center", backgroundColor: "lightGray" }}>user</Box>
            <Box sx={{ mb: "0rem", fontWeight: "600", border: "1px solid black", borderLeft: "none", display: "grid", gridArea: "user2", px: "0.5rem", justifyContent: "center", backgroundColor: "lightGray" }}>user</Box>
