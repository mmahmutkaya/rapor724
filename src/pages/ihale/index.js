...
const PAGE_KEY = 'ihale'
const DEFAULT_PAGE_SETTINGS = {
  showAciklama: true,
}


export default function P_Ihale() {
  ...
  return (
    <Box sx={{ minWidth: '40rem' }}>
      ...
      {!isFetching && !error && isPaketler.length === 0 && (
        <Stack sx={{ width: '100%', padding: '1rem' }}>
          <Alert severity="info">
            İhale yapabileceğiniz iş paketi bulunmuyor. Proje yöneticisi sizi bir iş paketine üye etmelidir.
          </Alert>
        </Stack>
      )}
