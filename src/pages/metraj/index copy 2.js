                ...
                >
                  ...
                  <Box>
                    ...
                    {pozlar?.filter(item => item._wbsId.toString() == oneWbs._id.toString()).map((onePoz, index) => {
                      ...
                      let isAnyMahalOpen_for_onePoz
                      // console.log("isAnyMahalOpen_for_onePoz",isAnyMahalOpen_for_onePoz)

                      isAnyMahalOpen_for_onePoz = mahalListesi?.find(x => x._pozId.toString() == onePoz._id.toString()) !== undefined
                      ...
                      return (
                        <Grid
                          ...
                          sx={{
                            display: "grid",
                            gridTemplateColumns: gridTemplateColumns_,
                            cursor: isAnyMahalOpen_for_onePoz ? "pointer" : "not-allowed"
                          }}
                          onClick={isAnyMahalOpen_for_onePoz ? () => setSelectedPoz(onePoz) : null}
                        >
                              ...
                              return (
                                <TableItem
                                  ...
                                  sx={{
                                    ...
                                    alignItems: "center",
                                    justifyItems: oneBaslik.yatayHiza,
                                    backgroundColor: isAnyMahalOpen_for_onePoz ? selectedPoz?._id.toString() == onePoz._id.toString() ? "yellow" : null : "lightgray"
                                  }}
                                >
